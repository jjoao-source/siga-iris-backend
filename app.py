...
from jose import JWTError, jwt  # <-- IMPORTAÇÃO QUE FALTAVA ADICIONADA AQUI

SECRET_KEY = "chave_super_secreta_universidade_ia"
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = 60

# Garantindo o caminho correto com barra inicial
oauth2_scheme = OAuth2PasswordBearer(tokenUrl="/api/auth/login")

app = FastAPI(title="API Sistema Universitario")

# Aponta para a pasta 'static' se ela existir
...
USUARIOS_DB = {
    "admin@univ.br": {
        ...
        "senha_hash": HASH_PADRAO, "perfil": "admin", "curso_id": None
    },
    "professor@univ.br": {
        "id": "DOC01", "nome": "Prof. Carlos Silva", "email": "professor@univ.br",
        "senha_hash": HASH_PADRAO, "perfil": "docente", "curso_id": 1
    },
    "aluno@univ.br": {
        "id": "EST01", "nome": "Ana Maria", "email": "aluno@univ.br",
        "senha_hash": HASH_PADRAO, "perfil": "estudante", "curso_id": 1
    }
}
...
def obter_grade_notas(usuario_atual: dict = Depends(obter_usuario_atual)):
    ...
    return {"tipo": "Licenciatura", "curso": curso["nome"], "grade": grade}
